...
_____________________QWERTY_L3______________________, _____________________QWERTY_R3______________________,
        _____________MOD_LEFT______________, KC_BSPC, KC_SPC, _____________MOD_RIGHT_____________
),

[_HOMEMODS] = LAYOUT_wrapper(
_____________________NUM_LEFT_______________________, _____________________NUM_RIGHT______________________,
_____________________QWERTY_L1______________________, _____________________QWERTY_R1______________________,
___________________QWERTY_L2_MODS___________________, ___________________QWERTY_R2_MODS___________________,
_____________________QWERTY_L3______________________, _____________________QWERTY_R3______________________,
        _____________MOD_LEFT______________, KC_BSPC, KC_SPC, _____________MOD_RIGHT_____________
),
...
/*
 * Util is accessed by holding Tab.
 */
[_UTIL] =  LAYOUT_wrapper(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MACOSLK,
 ...
 * |      | Reset|Debug | RGB  |RGBMOD| HUE+ | HUE- | SAT+ | SAT- |BRGTH+|BRGTH-|  Del |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |MUSmod|Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|Plover|Homod |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_wrapper(
    ...
    _______, RESET,   DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, KC_DEL ,
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  DVORAK,  PLOVER,  HOMOD,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case HOMOD:
      if (record->event.pressed) {
        set_single_persistent_default_layer(_HOMEMODS);
      }
      return false;
      break;
    case BACKLIT:
